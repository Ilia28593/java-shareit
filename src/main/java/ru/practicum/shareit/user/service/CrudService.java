...
public abstract class CrudService<T extends Entity> extends Service {
    ...
    public T create(T entity) {
        ...
        T e = getRepository().create(entity).orElseThrow(() -> getNoDataFoundException(Math.toIntExact(entity.getId())));
    ...
    public T update(T entity) {
        ...
        return this.getRepository().update(entity).orElseThrow(() -> getNoDataFoundException(Math.toIntExact(entity.getId())));
    }
    ...
    public T getById(long id) {
        ...
        validateIds(id);
        return this.getRepository().getById(id).orElseThrow(() -> new NotFoundException(getServiceType(), id));
    }
