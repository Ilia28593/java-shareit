...
public class ItemControllerTest {
    ...
    private final ItemDtoWithBookingDto itemResponseDto = Samples.getItemResponse1(1L);
    private final ItemDtoWithBookingDto itemResponseDto2 = Samples.getItemResponse2(2L);
    @MockBean
    ...
    void itemController_AddComment() throws Exception {
        ...
        CommentDto commentDto = Samples.getComment();
