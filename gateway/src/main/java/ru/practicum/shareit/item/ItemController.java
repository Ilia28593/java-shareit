...
public class ItemController {
    ...
    @GetMapping("/{itemId}")
    public ResponseEntity<Object> getById(@PathVariable long itemId, @RequestHeader(HEADER_USER_ID) long userId) {
        return itemClient.getById(itemId, userId);
    }

    @GetMapping
    public ResponseEntity<Object> findByUserId(@RequestHeader(HEADER_USER_ID) long userId,
    ...
    public void delete(@PathVariable long itemId, @RequestHeader(HEADER_USER_ID) long userId) {
